...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,NzColorPickerModule,NzTabsModule],
  templateUrl: './color-editor-text.component.html',
  styleUrl: './color-editor-text.component.scss',
  
})
export class ColorEditorTextComponent {
...
patterns:any[] = []
  constructor(private canvaService:CanvasUtilsService,private newArtFacade:ArtFacadeService, private artService:ArtService,private canvasService:CanvasUtilsService ){}
  ...
  changeColor(event:any){
      this.canvasService.setEditorEvent({name:'color-text', value:event.color.originalInput})
  }
  changeColorSwitch(color:any){
      this.canvasService.setEditorEvent({name:'color-text', value:"#"+color})
  }
